  ...
  return (
    <main className="flex justify-center flex-col my-[17px] mx-[20px] text-left">
      ...
      <div className="flex mt-[56px] items-end">
        <h1 className="text-left">Escoge tu rol a adoptar</h1>
        <img
          src={catBall.src}
      ...
      <p className="mt-[16px] mb-[32px]">
        ¿Eres una persona que tiene el deseo de darle la bienvenida a una almita
        muy especial o eres una persona que sabe de un almita que lo necesita?
      </p>
      <CardRol
        {...{
          text: "Quiero adoptar",
          image: dogAdoption.src,
          classes: "mb-[24px]",
          alt: "I want to adopt",
        }}
      />
      <CardRol
        {...{
          ...
          image: catDog.src,
          classes: "mb-[24px]",
          alt: "I want to give them up for adoption",
        }}
      />
        ...
        <div className="flex gap-x-[16px]">
          ...
          <Button
            {...{
              ...
              classes: "px-[16px] py-[14px] w-[164px] h-[40px]",
              alt: "",
