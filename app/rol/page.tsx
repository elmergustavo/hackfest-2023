        ...
        <main className="flex justify-center flex-col my-[17px] mx-[20px] text-left">
            ...
            <div className="flex justify-end">
                <div className="flex gap-x-[16px]">
                    <Button {...{ text: "", image: arrow.src, colorOfButton: "full-orange", classes: "px-[19px] py-[13px] w-[56px] h-[40px]", alt: "next" }} />
                    <Button {...{ text: "Ir al paso anterior", image: "", colorOfButton: "outline-black", classes: "px-[16px] py-[14px] w-[164px] h-[40px]", alt: "" }} />
                </div>
            </div>
        </main>
    )
