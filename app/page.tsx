  ...
  return (
    <main className="mx-[20px]">
      ...
      <div className='flex justify-center mt-[56px] flex-col items-center'>
        ...
        <Button {...{ text: "¡ Quiero adoptar !", image: "", colorOfButton: "black", classes: "px-[16px] py-[14px] w-[164px] h-[48px] my-[32px]" }} />
        ...
        <Button {...{ text: "¡ Quiero dar en adopción !", image: "", colorOfButton: "black", classes: "px-[16px] py-[14px] w-[228px] h-[40px] my-[32px]" }} />
