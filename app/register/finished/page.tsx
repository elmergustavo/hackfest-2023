    ...
    return (
        <main className="flex justify-center flex-col my-[17px] mx-[20px] text-left">
            ...
            <div className="flex items-center flex-col">
                <Button {...{ text: "¡ Iniciemos la aventura !", image: "", colorOfButton: "orange", classes: "px-[20px] py-[16px] w-[250px] h-[45px]", alt: "" }} />
                <Button {...{ text: "Ir al paso anterior", image: "", colorOfButton: "outline-black", classes: "px-[16px] py-[14px] w-[164px] h-[40px] mt-[16px] mb-[62px]", alt: "" }} />
            </div>
        </main>
    )
}
